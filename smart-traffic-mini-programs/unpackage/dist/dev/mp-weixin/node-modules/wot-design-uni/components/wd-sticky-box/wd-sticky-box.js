  ...
  setup(__props) {
    ...
    function observerForChild(child) {
      ...
      common_vendor.getRect(`#${styckyBoxId.value}`, false, proxy).then((res) => {
        ...
        common_vendor.index.__f__("log", "at node_modules/wot-design-uni/components/wd-sticky-box/wd-sticky-box.vue:125", res);
      });
    }
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/node-modules/wot-design-uni/components/wd-sticky-box/wd-sticky-box.js.map
